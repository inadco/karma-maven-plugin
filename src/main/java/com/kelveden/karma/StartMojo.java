...
public class StartMojo extends AbstractMojo {
     ...
     */
    @Parameter(defaultValue = "${basedir}/src/test/config/karma.conf.js", property = "configFile", required = true)
     ...
     * supported values.
     */
    @Parameter(property = "browsers", defaultValue="PhantomJS", required = false)
     ...
     */
    @Parameter(property = "autoWatch", defaultValue="true", required = false)
     ...
     * supported values.
     */
    @Parameter(property = "reporters", defaultValue="junit,dots,progress", required = false)
